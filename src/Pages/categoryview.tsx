...
export function CategoryView() {
  ...
  return (
    <>
      <NavBar />
      <p className="mt-2 mb-10 text-3xl font-bold tracking-tight sm:text-4xl">Categories</p>
        ...
        <Carousel className="w-full">
          <CarouselContent className="w-full gap-2">
            {productWithCat?.map((product) => (
              <CarouselItem className=" basis-1/4" key={product.categoryId}>
                <div className="p-1">
                  <Card key={product.id} className="w-[300px] h-[400px]">
                    <CardHeader>
                      <CardTitle>{product.categoryId}</CardTitle>
