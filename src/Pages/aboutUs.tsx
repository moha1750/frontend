        ...
        <div className="max-w-4xl flex items-center h-auto  flex-wrap mx-auto p-5">
          <div className="mx-auto p-4 md:p-12 text-center lg:text-center shadow-xl ">
            ...
            <p className="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
              ...
              Simple, Luxury, Limited & Unique Clothing
            </p>
            ...
            <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
              ...
              <Link className="link" to="#" data-tippy-content="@github_handle">
                <svg
                  className="h-6 fill-current "
                  role="img"
                  viewBox="0 0 24 24"
              ...
              <Link className="link" to="#" data-tippy-content="@unsplash_handle">
                <svg
                  className="h-6 fill-current "
                  role="img"
                  viewBox="0 0 24 24"
              ...
              <Link className="link" to="#" data-tippy-content="@youtube_handle">
                <svg
                  className="h-6 fill-current "
                  role="img"
                  xmlns="http://www.w3.org/2000/svg"
